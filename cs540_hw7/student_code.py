...
class LeNet(nn.Module):
    def __init__(self, input_shape=(32, 32), num_classes=100):
        ...
        #two convolutions and max_pools
        ...
        #setting layers
        self.layer1 = torch.nn.Linear(400, 256, bias=True)
        self.layer2 = torch.nn.Linear(256, 128, bias=True)
        self.layer3 = torch.nn.Linear(128, 100, bias=True)
    


    def forward(self, x):
    
        #save shape of size of maxPool
        shape_dict = {}
